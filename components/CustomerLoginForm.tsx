...
export default function CustomerLoginForm() {
  ...
  return (
    ...
    >
      <h1 className="text-lg font-semibold text-shop-text">เข้าสู่ระบบ</h1>
      ...
      <p className="mt-4 text-center text-xs text-shop-text-soft">
        ยังไม่มีบัญชี? สร้างได้หลังสั่งซื้อสำเร็จในหน้ายืนยันคำสั่งซื้อ
      </p>
    </form>
  );
}
